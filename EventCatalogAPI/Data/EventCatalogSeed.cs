...
namespace EventCatalogAPI.Data
{
    public static class EventCatalogSeed
    {
        ...
        private static IEnumerable<EventItem> GetPreconfiguredEventItems()
        {
            ...
            {
                new EventItem() {EventTypeId = 1, EventCategoryId =2, EventLocationId = 1, EventName = "Kirkland Oktoberest", OrganizerName = "Kirkland Community", VenueName = "Performance center", Date = "09/20/2019", Time = "7:00PM", TicketPrice = 10, PictureUrl = "http://externaleventbaseurltobereplaced/api/pic/1"},
                new EventItem() {EventTypeId = 2, EventCategoryId =2, EventLocationId = 1, EventName = "Gobble Up Seattle 2019", OrganizerName = "Urban Craft", VenueName = "Magnuson Park", Date = "11/23/2019", Time = "10:00AM", TicketPrice = 15, PictureUrl = "http://externaleventbaseurltobereplaced/api/pic/2"},
                ...
                new EventItem() {EventTypeId = 1, EventCategoryId =2, EventLocationId = 2, EventName = "Chicago Fest", OrganizerName = "Mount Prospect Public Library", VenueName = "Cantigny Park", Date = "12/01/2019", Time = "5:00PM", TicketPrice = 10, PictureUrl = "http://externaleventbaseurltobereplaced/api/pic/4"},
